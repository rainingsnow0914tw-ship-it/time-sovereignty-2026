...
const zhTW: Record<string, string> = {
  ...
  "Re-pair to open your saved goals": "重新配對以開啟已儲存的目標",
  "Your cloud goals were not deleted. Restore the protected device session, then return here to continue them.": "你的雲端目標沒有被刪除。恢復受保護的裝置工作階段後，就能回到這裡繼續。",
  "Your protected device session is ready. Return to the private workspace to open saved goals or continue the waiting setup.": "受保護的裝置工作階段已就緒。回到私人工作區即可開啟已儲存的目標，或繼續剛才的設定。",
  "Back to my goals": "回到我的目標",
  ...
  "30-day story lab": "30 天故事實驗室",
  "Demo Lab · no API": "Demo Lab · 不使用 API",
  "Demo Lab check-in · scripted locally with mock traces. No API, Cloud Task, Firestore, or private session is used.": "Demo Lab 報到 · 本機腳本與 mock 軌跡；不使用 API、Cloud Task、Firestore 或私人工作階段。",
  "Scripted simulation · mock traces · no API": "腳本模擬 · mock 軌跡 · 不使用 API",
  "✓ Demo isolation: no API or private session": "✓ Demo 隔離：不使用 API 或私人工作階段",
  "Isolated scripted story · browser-only · no API or private data": "隔離腳本故事 · 僅限瀏覽器 · 不使用 API 或私人資料",
  "Scripted time advanced. No API or private data was used.": "腳本時間已推進；未使用 API 或私人資料。",
  "The complete scripted 30-day story is now visible in Journey and Developer.": "完整的 30 天腳本故事已顯示在「旅程」與「開發者」頁面。",
  "Simulated Day": "模擬第",
  "events": "個事件",
