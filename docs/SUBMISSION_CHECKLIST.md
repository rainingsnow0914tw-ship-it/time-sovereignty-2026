...
- [x] Three-question onboarding and user-approved plan
- [x] Support agreement and quiet-hours boundary
- [x] Dual action/intervention state machines
- [x] Chief of Staff plus three specialist Agents
- [x] Text check-in and tap-to-play TTS
- [x] Voice transcription boundary with text fallback
- [x] Single-delay and repeated-delay recovery paths
- [x] Text, photo, and voice progress
